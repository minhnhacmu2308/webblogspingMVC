...
<body>
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">blogs</h2>
              ...
              <div class="card card-table">
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                     <c:forEach var="item" items="${ listBlogs}">
                      <tr>
                        <td class="user-avatar"> <img src="<c:url value="/images/${item.image }"/>" alt="Avatar">${item.author }</td>
                        <td>${item.title}</td>
                         <td>${item.detail }</td>
